...
# Label 控件 文本
#root：窗口对象 text:文本  bg:背景颜色 字体颜色：fg='#fff  font:字体类型和大小 wraplength:文字多宽后换行 justify:设置文本对齐方式 left right top bommon anchor:文本位置 n北 e东 s南 w西 center 居中 
...
messagebox.askretrycancel("Retry", "Askretrycancel test.")
...
if __name__=='__main__':
	...
	for i in range(5):
		...
		btn.bind("<Button-1>", handlerAdaptor(handler, a=1*i, b=2*i, c=3*i))
		btn.pack()
